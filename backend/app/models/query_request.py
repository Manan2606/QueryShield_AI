...
class QueryRequest(Base):
    ...
    generated_for_table_id: Mapped[str | None] = mapped_column(String, nullable=True)
    model_name: Mapped[str | None] = mapped_column(String, nullable=True)
    generation_status: Mapped[str] = mapped_column(
        String, nullable=False, default="pending"
    )
    validation_status: Mapped[str] = mapped_column(
        String, nullable=False, default="not_validated"
    )
    ...
    dry_run_status: Mapped[str] = mapped_column(
        String, nullable=False, default="not_run"
    )
    dry_run_valid: Mapped[bool | None] = mapped_column(nullable=True)
    estimated_bytes_processed: Mapped[int | None] = mapped_column(
    ...
    dry_run_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    ...
    execution_status: Mapped[str] = mapped_column(
        String, nullable=False, default="not_executed"
    )
    ...
    execution_location: Mapped[str | None] = mapped_column(String, nullable=True)
    execution_bytes_processed: Mapped[int | None] = mapped_column(
        BigInteger, nullable=True
    )
    execution_bytes_billed: Mapped[int | None] = mapped_column(
        BigInteger, nullable=True
    )
    execution_cache_hit: Mapped[bool | None] = mapped_column(nullable=True)
    ...
    ai_summary_status: Mapped[str] = mapped_column(
        String, nullable=False, default="not_available"
    )
