...
class QueryRequest(Base):
    ...
    execution_status: Mapped[str] = mapped_column(String, nullable=False, default="not_executed")
    ...
    execution_bytes_processed: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    execution_bytes_billed: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
